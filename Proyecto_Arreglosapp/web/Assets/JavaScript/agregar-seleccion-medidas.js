...
document.getElementById('btnAgregarSeleccion').addEventListener('click', function (e) {
    ...
    data.append('arregloId', '4');
    data.append('categoria', 'Arreglos de Medidas');
    data.append('nombreCategoria', 'Arreglo de Medidas y Ajustes');
    data.append('precio', '15000');
    data.append('imagenUrl', 'Assets/image/imagen-arreglos-de-vestidos-de-fiesta.jpg');
