            ...
            <%@ page import="java.util.Map" %>
                <%@ page import="java.text.SimpleDateFormat" %>
                    <% Usuario admin=(Usuario) session.getAttribute("usuario"); if (admin==null || admin.getRolId() !=1)
                        ...
                        double total = detalle.get("total") instanceof Number ? ((Number)
                        detalle.get("total")).doubleValue() : 0.0;
                        ...
                        if ("confirmado".equals(estado)) { estadoClass = "pedido__estado--confirmado"; estadoLabel =
                        "Pendiente de Inicio"; }
                        else if ("en_proceso".equals(estado)) { estadoClass = "estado-badge--en-taller"; estadoLabel =
                        "En Taller"; }
                        else if ("terminado".equals(estado)) { estadoClass = "estado-badge--entregado"; estadoLabel =
                        "Terminado"; }
                        else if ("cancelado".equals(estado)) { estadoClass = "estado-badge--cancelado"; estadoLabel =
                        "Cancelado"; }
                        String citaEstadoClass = "estado-badge--pendiente";
                        String citaEstadoLabel = "Programada";
                        if ("confirmada".equals(citaEstado)) { citaEstadoClass = "pedido__estado--confirmado";
                        citaEstadoLabel = "Confirmada"; }
                        else if ("completada".equals(citaEstado)) { citaEstadoClass = "estado-badge--entregado";
                        citaEstadoLabel = "Completada"; }
                        else if ("cancelada".equals(citaEstado)) { citaEstadoClass = "estado-badge--cancelado";
                        citaEstadoLabel = "Cancelada"; }
                        String motivoLabel = "Consulta";
                        if ("entrega_prenda".equals(citaMotivo)) motivoLabel = "Entrega de prenda";
                        else if ("recogida_prenda".equals(citaMotivo)) motivoLabel = "Recogida de prenda";
                        else if ("toma_medidas".equals(citaMotivo)) motivoLabel = "Toma de medidas";
                        ...
                        <body class="grid-principal">
                            ...
                            <main class="detalle-pedido" id="contenido-principal" role="main">
                                ...
                                <h2 style="font-size:16px;font-weight:600;color:#3d0072;">Pedido #P-<%=
                                ...
                                <div class="info-seccion">
                                    ...
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Nombre:</span><span class="info-seccion__valor">
                                            <%= cliente %>
                                        </span></div>
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Email:</span><span class="info-seccion__valor">
                                            <%= email %>
                                        </span></div>
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Direccion:</span><span
                                            class="info-seccion__valor">
                                ...
                                <div class="info-seccion">
                                    ...
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Motivo:</span><span class="info-seccion__valor">
                                            <%= motivoLabel %>
                                        </span></div>
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Fecha y hora:</span><span
                                            class="info-seccion__valor">
                                            <%= citaStr %>
                                        </span></div>
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Estado cita:</span><span
                                            class="estado-badge <%= citaEstadoClass %>"
                                            style="font-size:12px;padding:3px 10px;">
                                            <%= citaEstadoLabel %>
                                        </span></div>
                                    <% if (citaNotas !=null && !citaNotas.isEmpty()) { %>
                                        <div class="info-seccion__campo info-seccion__campo--inline"><span
                                                class="info-seccion__label">Notas:</span><span
                                                class="info-seccion__valor">
                                                <%= citaNotas %>
                                            </span></div>
                                        <% } %>
                                ...
                                <div class="info-seccion">
                                    ...
                                    <div class="info-seccion__campo info-seccion__campo--inline"><span
                                            class="info-seccion__label">Total:</span><span class="info-seccion__valor"
                                ...
                                <div class="estado-pedido">
                                    ...
                                    <% if (!esFinal && citaEstado !=null) { %>
                                        <div
                                            style="margin-top:20px;padding:15px;background:#f5f0ff;border-radius:10px;border-left:4px solid #673ab7;">
                                            <p style="font-size:13px;color:#673ab7;font-weight:600;margin-bottom:12px;">
                                                Gestionar estado de la cita:</p>
                                            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                                                <% if ("programada".equals(citaEstado)) { %>
                                                    <form action="/Proyecto_Arreglosapp/AdminServlet" method="post"
                                                        style="display:inline;">
                                                        <input type="hidden" name="accion" value="cambiarEstadoCita">
                                                        <input type="hidden" name="citaId" value="<%= detalle.get("citaId") !=null ? detalle.get("citaId") : "" %>">
                                                        <input type="hidden" name="nuevoEstado" value="confirmada">
                                                        <button type="submit" class="perfil__btn-guardar"
                                                    ...
                                                    <% } else if ("confirmada".equals(citaEstado)) { %>
                                                        <form action="/Proyecto_Arreglosapp/AdminServlet" method="post"
                                                            style="display:inline;">
