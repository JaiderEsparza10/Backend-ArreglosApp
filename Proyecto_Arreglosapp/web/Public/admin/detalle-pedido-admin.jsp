...
<body class="grid-principal">
    ...
    <main class="detalle-pedido">
        ...
        <!-- Servicio Solicitado -->
        <section class="info-seccion">
            <h2 class="info-seccion__titulo">Servicio Solicitado</h2>
            <div class="info-seccion__campo">
                <span class="info-seccion__label">Ajuste de Vestido:</span>
                <p class="servicio-info__descripcion">
                    Necesito reducirle un poco de la cintura, también cortar el largo del vestido y tomarle el
                    dobladillo.
                </p>
            </div>
            <div class="info-seccion__campo info-seccion__campo--inline">
                <span class="info-seccion__label">Material:</span>
                <span class="info-seccion__valor">Seda de lino fino</span>
            </div>
        </section>
