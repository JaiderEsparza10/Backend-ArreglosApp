...
<body class="grid-principal">
    ...
    <main class="dashboard">
        ...
        <form class="formulario-servicio" action="servicio-actualizado.jsp" method="get">
            ...
            <div class="formulario-servicio__grupo">
                <label class="formulario-servicio__label">Descripción del Servicio</label>
                <textarea class="formulario-servicio__textarea"
                    placeholder="Descripción del servicio...">Reparamos todo tipo de prendas con técnicas profesionales de costura.</textarea>
            </div>

            <div class="formulario-servicio__grupo">
                <label class="formulario-servicio__label">Precio de Venta</label>
                <input type="text" class="formulario-servicio__input" placeholder="$25,000" value="$25,000">
            </div>
