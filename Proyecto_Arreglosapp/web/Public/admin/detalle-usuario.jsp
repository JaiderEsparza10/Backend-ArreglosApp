...
<body class="grid-principal">
    ...
    <main class="detalle-usuario">
        <div class="detalle-usuario__avatar">
            <div class="detalle-usuario__avatar-circulo">
                <img src="../../Assets/icons/user.png" alt="avatar" class="detalle-usuario__avatar-icono">
            </div>
        </div>

        <h2 class="info-usuario__titulo">Información Personal</h2>

        <div class="info-usuario__campo">
            <span class="info-usuario__label">Nombre</span>
            <span class="info-usuario__valor">Jaider Andrés Esparza Arenas</span>
        </div>

        <div class="info-usuario__campo">
            <span class="info-usuario__label">Correo</span>
            <span class="info-usuario__valor">xenno2003@gmail.com</span>
        </div>

        <div class="info-usuario__campo">
            <span class="info-usuario__label">Telefono</span>
            <span class="info-usuario__valor">3107566832</span>
        </div>

        <div class="info-usuario__campo">
            <span class="info-usuario__label">Dirección</span>
            <span class="info-usuario__valor">Calle 9nb 2occ 04</span>
        </div>

        <div class="info-usuario__medidas">
            <span class="info-usuario__medidas-label">Medidas guardadas</span>
            <a href="#modal-medidas" class="info-usuario__medidas-enlace">Ver Medidas</a>
        </div>

        <a href="#modal-eliminar" class="detalle-usuario__btn-eliminar">Eliminar Cuenta</a>

        <div id="modal-medidas" class="modal">
            <div class="modal-contenido modal-medidas">
                <h2 class="modal-medidas__titulo">Medidas</h2>
                <div class="modal-medidas__lista">
                    <span class="modal-medidas__item">Medida Busto: 90cm</span>
                    <span class="modal-medidas__item">Medida Cintura: 100cm</span>
                    <span class="modal-medidas__item">Altura de la persona: 1,70</span>
                </div>
