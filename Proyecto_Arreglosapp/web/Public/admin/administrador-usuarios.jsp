...
<body class="grid-principal">
    ...
    <div id="modalEliminar" class="modal-overlay" style="display:none;">
        <div class="modal-contenido">
            ...
            <div class="modal__acciones">
                ...
                <form method="post" action="/Proyecto_Arreglosapp/AdminServlet" id="formEliminar" style="flex:1;display:flex;">
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            ...
            if (params.get('error') === 'dependencias') {
                mostrarToast('No se puede eliminar el usuario. Tiene datos asociados (pedidos, favoritos, etc.)', 'error');
            } else if (params.get('error') === 'dependencias_importantes') {
                mostrarToast('No se puede eliminar el usuario. Tiene datos importantes asociados (pedidos, personalizaciones o citas)', 'error');
            } else if (params.get('error') === 'no_encontrado') {
                mostrarToast('Usuario no encontrado o no es un cliente', 'error');
            } else if (params.get('error') === 'general') {
                var msg = params.get('msg') || 'Error al eliminar usuario';
