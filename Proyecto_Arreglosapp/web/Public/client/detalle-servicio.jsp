        ...
        <%@ page import="model.Servicio" %>
            <%@ page import="dao.ServicioDAO" %>
                <% HttpSession sesion=request.getSession(false); Usuario usuario=null; if (sesion !=null) {
                    ...
                    idParam=request.getParameter("id"); Servicio servicio=null; if (idParam !=null &&
                    ...
                    + "/Assets/image/logo-app.png" ; if (imgUrl !=null && !imgUrl.trim().isEmpty()) { if
                    (imgUrl.startsWith("../../")) { imgSrc=ctx + "/" + imgUrl.replace("../../", "" ); } else if
                    (imgUrl.startsWith("Assets/")) { imgSrc=ctx + "/" + imgUrl; } else if (imgUrl.startsWith("http")) {
                    imgSrc=imgUrl; } else { imgSrc=ctx + "/" + imgUrl; } } String nombre=servicio.getNombre() !=null ?
                    servicio.getNombre() : "" ; String descripcion=servicio.getDescripcion() !=null ?
                    servicio.getDescripcion() : "Sin descripcion" ; String tiempo=servicio.getTiempoEstimado() !=null ?
                    servicio.getTiempoEstimado() : "No definido" ; String precio=String.format("%,.0f",
                    ...
                    <body class="grid-principal">
                        ...
                        <main class="detalle-servicio">
                            <div class="detalle-servicio__encabezado">
                                <a href="pagina-principal.jsp" class="detalle-servicio__volver">
                            ...
                            <div class="detalle-servicio__card">
                                <img src="<%= imgSrc %>" alt="<%= nombre %>" class="detalle-servicio__card-imagen">
                                <div class="detalle-servicio__card-info">
                                    <h2 class="detalle-servicio__card-nombre">
                                        <%= nombre %>
                                    </h2>
                                    <span class="detalle-servicio__card-precio">$<%= precio %></span>
                                    <span class="detalle-servicio__card-tiempo">⏱ <%= tiempo %></span>
                                </div>
                            </div>

                            <div class="detalle-servicio__descripcion-contenedor">
                                <h2 class="detalle-servicio__subtitulo">Descripción</h2>
                                <p class="detalle-servicio__descripcion">
                                    <%= descripcion %>
                                </p>
                            </div>

                            <div class="detalle-servicio__acciones">
                                <button class="detalle-servicio__btn detalle-servicio__btn--seleccion" id="btnAgregar"
