<%-- 
    ...
    Propósito: Interfaz para gestionar las personalizaciones de ropa en cotización o taller.
--%>
...
<% 
    ...
    String mensajeOk = (String) sesion.getAttribute("mensajePersonalizacion");  String mensajeErr = (String) sesion.getAttribute("errorPersonalizacion");  sesion.removeAttribute("mensajePersonalizacion"); sesion.removeAttribute("errorPersonalizacion"); 
...
%>
              ...
              <body class="grid-principal"> <header class="seccion-encabezado"> <img class="seccion-encabezado__logo" src="../../Assets/image/logo-app.png"
                ...
                <div id="toast" class="toast"></div> <main class="contenido-arreglos"> <h1 class="contenido__titulo-seleccion">Mis Arreglos</h1>
                  ...
                  <% if (misArreglos !=null && !misArreglos.isEmpty()) { %>
                    <% for (Personalizacion arreglo : misArreglos) { %>
                      <% 
                        ...
                        String estado = arreglo.getEstado() != null ? arreglo.getEstado() : "pendiente"; String badgeClase = "badge--pendiente"; String estadoTexto = "Pendiente"; if (estado.equalsIgnoreCase("en_proceso")) { badgeClase = "badge--proceso"; estadoTexto = "En proceso"; } else if (estado.equalsIgnoreCase("completado")) { badgeClase = "badge--completado"; estadoTexto = "Completado";
                        }
                        ...
                        <section class="contenido-seleccion__contenedor arreglo-card"> <img class="contenedor__imagen" src="<%= imgSrc %>" alt="Imagen del arreglo"> <div class="contenido-seleccion__contenedor-informacion"> <div class="contenedor-informacion__informacion"> <div class="informacion__fila-titulo"> <h2 class="informacion__titulo-arreglo">
                            ...
                            <div class="contenedor-informacion__enlaces"> <a class="enlaces__enlace-arreglos" href="<%= urlEditar %>">Editar</a> <a class="enlaces__enlace-arreglos" href="#"
                        ...
                        <% } %>
                          <% } else { %>
                            <div class="arreglos__vacio"> <p class="arreglos__vacio-texto">No tienes arreglos personalizados aún.</p> <a href="pagina-principal.jsp" class="informacion__enlace-personalizar">Ver Servicios</a>
                            </div>
                            <% } %>
                </main>

                <!-- MODAL ELIMINAR -->
                <div id="modalEliminarArreglo" class="modal"> <div class="modal-contenido"> <h3 class="modal__titulo">¿Eliminar arreglo?</h3> <p class="modal__descripcion">¿Estás seguro que quieres eliminar esta personalización? Esta acción
                      no se puede deshacer.</p>
                    <div class="modal__acciones"> <button class="btn-modal btn-modal--cancelar" onclick="cerrarModalArreglo()">CANCELAR</button> <button class="btn-modal btn-modal--eliminar" id="btnConfirmarEliminarArreglo">ELIMINAR</button>
                    </div>
                  </div>
                </div>
                ...
                <footer class="navbar"> <nav class="navbar-inferior"> <a href="pagina-principal.jsp" class="navbar-inferior__item"> <img src="../../Assets/icons/casa-blanca.png" class="navbar-inferior__icono"> <span class="navbar-inferior__texto">Inicio</span>
                    ...
                    <a href="mi-seleccion.jsp" class="navbar-inferior__item"> <img src="../../Assets/icons/lista-de-deseos-transparente.png" class="navbar-inferior__icono"> <span class="navbar-inferior__texto">Mi selección</span>
                    </a>
                    <a href="mis-arreglos.jsp" class="navbar-inferior__item"> <img src="../../Assets/icons/cortar-con-tijeras-transparente.png" class="navbar-inferior__icono"> <span class="navbar-inferior__texto">Mis Arreglos</span>
                    </a>
