    ...
    <main class="terminos-condiciones">
        ...
        <div class="terminos-condiciones__informacion">
            ...
            <p class="informacion__contenido">
                ...
                la actividad que ocurra bajo su cuenta.
                Medidas de Ropa: La aplicación le permite guardar y gestionar sus medidas de ropa para personalizar
                arreglos. La exactitud de estas medidas es crucial y su responsabilidad exclusiva, ya que influyen
                directamente en la calidad del arreglo final.
            </p>
            <p class="informacion__contenido">
                ...
                Presupuesto Final: El precio definitivo de un arreglo se confirmará después de que nuestro personal
                evalúe físicamente su prenda. Usted siempre tendrá la opción de aceptar o rechazar este presupuesto
                final antes de que se inicie el trabajo.
            </p>
            <p class="informacion__contenido">
                4. Agendamiento de Citas y Cancelaciones
                Citas: Para que sus arreglos personalizados sean procesados, deberá agendar una cita a través de la app
                para la recogida de sus prendas y la posterior entrega. Haremos lo posible por cumplir sus preferencias
                de fecha y hora.
            </p>
        </div>
    </main>
