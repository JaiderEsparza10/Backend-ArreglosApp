...
<body class="contenedor-encabezado-detalles">
    ...
    <main class="contenido-detalles">
        <div class="contenido-detalles_informacion-detalles">
            <img class="informacion-detalles__imagen-arreglo" src="../../Assets/image/image-arreglo-bolsillos.jpg" alt="Imagen de detalles del arreglo">
            <div class="informacion-detalles__informacion">
                <h1 class="informacion__titulo" >Arreglo de Bolsillos y Remiendos</h1>
                <p class="informacion__parrafo">Reparamos los daños más comunes como bolsillos rotos, costuras descosidas y remiendos en áreas desgastadas. Devolvemos la funcionalidad y apariencia original a tu ropa.</p>
