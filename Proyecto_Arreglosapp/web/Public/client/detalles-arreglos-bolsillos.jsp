...
<body class="contenedor-encabezado-detalles"> <header class="contenedor-encabezado-detalles__encabezado"> <a class="encabezado__enlace" href="pagina-principal.jsp"> <img class="enlace__imagen" src="../../Assets/icons/flecha-izquierda__blanca.png" alt="flecha atras">
    ...
    <main class="contenido-detalles"> <div class="contenido-detalles_informacion-detalles"> <img class="informacion-detalles__imagen-arreglo" src="../../Assets/image/image-arreglo-bolsillos.jpg"
                alt="Imagen de detalles del arreglo"> <div class="informacion-detalles__informacion"> <h1 class="informacion__titulo">Arreglo de Bolsillos y Remiendos</h1> <p class="informacion__parrafo">Reparamos los daños más comunes como bolsillos rotos, costuras
    ...
    <div id="toast" class="toast"></div> <script src="../../Assets/JavaScript/agregar-seleccion-bolsillos.js"></script>
</body>
