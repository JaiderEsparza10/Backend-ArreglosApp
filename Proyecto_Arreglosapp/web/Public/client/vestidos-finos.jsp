...
<body class="contenedor-encabezado-detalles">
    ...
    <main class="contenido-detalles">
        <div class="contenido-detalles_informacion-detalles">
            <img class="informacion-detalles__imagen-arreglo" src="../../Assets/image/imagen-vestidos-finos.jpg"
                alt="Imagen de detalles del arreglo">
            <div class="informacion-detalles__informacion">
                <h1 class="informacion__titulo">Ajuste Fino de Vestidos y Ropa</h1>
                <p class="informacion__parrafo">Especializados en ajustes precisos para vestidos de fiesta,
    ...
    <script src="../../Assets/JavaScript/agregar-seleccion-vestidos.js"></script>
</body>
