...
%>
                                ...
                                <body class="grid-principal"> <a href="#contenido-principal" class="skip-link">Saltar al contenido</a> <header class="seccion-encabezado"> <img class="seccion-encabezado__logo" src="../../Assets/image/logo-app.png"
                                    ...
                                    <main class="contenido" id="contenido-principal" role="main"> <div class="contenido__barra-busqueda"> <img src="../../Assets/icons/lupa.png" alt="lupa"> <input type="text" name="buscador" id="buscador"
                                        ...
                                        <div class="contenido__filtros" style="display: flex; gap: 10px; margin-bottom: 20px; align-items: center; justify-content: center; background: white; padding: 10px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);"> <label for="precioMax" style="font-size: 13px; font-weight: 500; color: #444;">Precio máximo: </label> <input type="range" id="precioMax" min="0" max="500000" step="10000" value="500000" style="cursor: pointer;"> <span id="labelPrecioMax" style="font-size: 14px; font-weight: 600; color: #7c4dff;">$500.000</span>
                                        </div>
                                                ...
                                                <% if (servicios.isEmpty()) { %>
                                                    ...
                                                    <% } %>
                                                        <% for (int i=0; i < servicios.size(); i++) { Servicio
                                                            ...
                                                            precio=String.format("%,.0f", s.getPrecioBase()); %> <article class="tarjeta-arreglo"
                                                                data-nombre="<%= nombreLower %>"
                                                                data-precio="<%= s.getPrecioBase() %>"> <div class="tarjeta-arreglo__imagen-contenedor"> <img src="<%= imgSrc %>" alt="<%= nombre %>">
                                                                </div>
                                                                <div class="tarjeta-arreglo__contenido"> <h3 class="tarjeta-arreglo__nombre">
                                                                        <%= nombre %>
                                                                    </h3>
                                                                    <div class="tarjeta-arreglo__footer"> <p class="tarjeta-arreglo__precio">$<%= precio
                                                                                %>
                                                                        </p>
                                    ...
                                    <footer class="navbar"> <nav class="navbar-inferior" role="navigation" aria-label="Navegación principal"> <a href="pagina-principal.jsp" class="navbar-inferior__item navbar-inferior__item--activo" aria-current="page" aria-label="Inicio"> <img src="../../Assets/icons/casa-blanca.png" class="navbar-inferior__icono" alt=""> <span class="navbar-inferior__texto">Inicio</span>
                                            </a>
