...
<body class="grid-principal">
    ...
    <main class="contenido-arreglos">
        <div class="contenido-arreglos__enlace-volver">
            <a href="pagina-principal.jsp" class="enlace-volver__texto">← Volver</a>
            <h1 class="enlace-volver__titulo">Mis Favoritos</h1>
        </div>
    ...
    <footer class="navbar">
        <nav class="navbar-inferior">
            <a href="pagina-principal.jsp" class="navbar-inferior__item">
                <img src="../../Assets/icons/inicio.png" alt="icono de inicio" class="navbar-inferior__icono">
                <span class="navbar-inferior__texto">Inicio</span>
            </a>
            <a href="mis-arreglos.jsp" class="navbar-inferior__item">
                <img src="../../Assets/icons/arreglos.png" alt="icono de arreglos" class="navbar-inferior__icono">
                <span class="navbar-inferior__texto">Mis Arreglos</span>
            </a>
            <a href="mi-perfil.jsp" class="navbar-inferior__item">
                <img src="../../Assets/icons/usuario.png" alt="icono de usuario" class="navbar-inferior__icono">
                    ...
                    if (data.success && data.data && data.data.length > 0) {
                        container.innerHTML = data.data.map(favorito => `
                            <article class="tarjeta-arreglo">
                                <div class="tarjeta-arreglo__imagen-contenedor">
                                    <img src="${favorito.imagenUrl}" alt="${favorito.nombreCategoria}" class="tarjeta-arreglo__imagen">
                                </div>
                                <div class="tarjeta-arreglo__contenido">
                                    <h3 class="tarjeta-arreglo__nombre">${favorito.nombreCategoria}</h3>
                                    <p class="tarjeta-arreglo__categoria">${favorito.categoria}</p>
                                    <div class="tarjeta-arreglo__footer">
                                        <p class="tarjeta-arreglo__precio">$${favorito.precio.toLocaleString('es-CO')}</p>
                                        <button onclick="eliminarFavorito(${favorito.favoritoId})" class="tarjeta-arreglo__eliminar">
                                            Eliminar
                                        </button>
                                    </div>
                                </div>
                        ...
                        container.innerHTML = `
                            <div class="empty-state">
                                <img src="../../Assets/icons/corazon-vacio.png" alt="icono de favoritos vacíos" class="empty-state__icono">
                                <h3 class="empty-state__titulo">No tienes favoritos</h3>
                                <p class="empty-state__texto">Agrega servicios a tus favoritos para verlos aquí</p>
                                <a href="pagina-principal.jsp" class="empty-state__boton">Explorar Servicios</a>
                            </div>
                        `;
                    }
                })
