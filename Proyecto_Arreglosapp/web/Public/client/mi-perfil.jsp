    ...
    <main class="contenido-perfil">
        ...
        <section class="perfil-informacion">
            <div class="perfil__avatar">
                <img src="../../Assets/icons/usuario-perfil.png" alt="avatar de usuario" class="perfil__imagen">
            </div>
            
            <div class="perfil__datos">
                <h2 class="perfil__nombre"><%= usuario.getNombre() %></h2>
                <p class="perfil__email"><%= usuario.getEmail() %></p>
                <p class="perfil__direccion"><%= usuario.getDireccion() != null ? usuario.getDireccion() : "Sin dirección registrada" %></p>
                <p class="perfil__rol">
