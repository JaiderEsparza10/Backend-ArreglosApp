<%-- 
    ...
    Propósito: Detalle informativo sobre los servicios de ajuste de medidas y entallado de prendas.
--%>
<!DOCTYPE html>
<html lang="es">
...
<body class="contenedor-encabezado-detalles"> <header class="contenedor-encabezado-detalles__encabezado"> <a class="encabezado__enlace" href="pagina-principal.jsp"> <img class="enlace__imagen" src="../../Assets/icons/flecha-izquierda__blanca.png" alt="flecha atras">
    ...
    <main class="contenido-detalles"> <div class="contenido-detalles_informacion-detalles"> <img class="informacion-detalles__imagen-arreglo"
                src="../../Assets/image/imagen-arreglos-de-vestidos-de-fiesta.jpg" alt="Imagen de detalles del arreglo"> <div class="informacion-detalles__informacion"> <h1 class="informacion__titulo">Arreglo de Medidas y Ajustes</h1> <p class="informacion__parrafo">Realizamos ajustes precisos a tus prendas para que se adapten
    ...
    <div id="toast" class="toast"></div> <script src="../../Assets/JavaScript/agregar-seleccion-medidas.js"></script>
</body>
