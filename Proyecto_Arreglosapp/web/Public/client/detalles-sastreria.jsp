...
<body class="contenedor-encabezado-detalles">
    ...
    <main class="contenido-detalles">
        <div class="contenido-detalles_informacion-detalles">
            <img class="informacion-detalles__imagen-sastreria" src="../../Assets/image/imagen-sastreria.jpg" alt="Imagen de detalles del arreglo">
            <div class="informacion-detalles__informacion">
                <h1 class="informacion__titulo" >Sastrería y Dobladillos</h1>
                <p class="informacion__parrafo">Destaca la calidad y el cuidado artesanal de los arreglos, enfatizando la precisión y la atención al detalle en trabajos que requieren técnica manual.</p>
