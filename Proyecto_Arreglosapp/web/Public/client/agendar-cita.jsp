    ...
    <%@ page import="model.Usuario" %>
        <% HttpSession sesion=request.getSession(false); Usuario usuario=null; if (sesion !=null) { usuario=(Usuario)
            ...
            <body class="grid-principal">
                ...
                <main class="contenido-cita">
                    <div class="contenido-cita__encabezado">
                    ...
                    <% if (errorMsg !=null) { %>
                        ...
                        <% } %>
                            ...
                            <form class="cita__formulario" action="/Proyecto_Arreglosapp/CitaServlet" method="post"
                                ...
                                <input type="hidden" name="fechaCita" id="fechaCitaInput">

                                <!-- CALENDARIO DINÁMICO -->
                                <div class="cita__seccion">
                                    <h2 class="cita__titulo-seccion">Selecciona una Fecha</h2>
                                    <div class="cita__calendario" id="calendario">
                                        <div class="calendario__cabecera">
                                            <button type="button" class="calendario__btn-nav"
                                                id="btnMesAnterior">&#8249;</button>
                                            <span class="calendario__mes-actual" id="mesActual"></span>
                                            <button type="button" class="calendario__btn-nav"
                                ...
                                <!-- HORA -->
                                <div class="cita__seccion">
                                    <h2 class="cita__titulo-seccion">Hora de la Cita</h2>
                                ...
                                <!-- LUGAR DE ENTREGA -->
                                <div class="cita__seccion">
                                    <h2 class="cita__titulo-seccion">Lugar de Entrega / Recogida</h2>
                                    <div class="cita__input-icono">
                                        <img src="../../Assets/icons/entrega-rapida.png" alt="entrega"
                                            class="cita__icono-input">
                                        <input type="text" name="direccionEntrega" class="cita__input"
                                ...
                                <!-- BOTÓN -->
                                <div class="cita__seccion-boton">
                                    <button type="submit" class="cita__btn-confirmar" id="btnConfirmarCita">
                                        Confirmar Cita
                                    </button>
                                </div>
                            </form>
